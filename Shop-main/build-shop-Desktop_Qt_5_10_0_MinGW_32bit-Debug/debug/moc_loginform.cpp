...
#include "../../shopy(26.11.2023)/loginform.h"
...
QT_MOC_LITERAL(1, 10, 17), // "userAuthenticated"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7), // "isAdmin"
QT_MOC_LITERAL(4, 37, 21), // "authenticationSuccess"
QT_MOC_LITERAL(5, 59, 22), // "on_loginButton_clicked"
QT_MOC_LITERAL(6, 82, 24), // "on_adminCheckBox_toggled"
QT_MOC_LITERAL(7, 107, 7), // "checked"
QT_MOC_LITERAL(8, 115, 22), // "onCheckBoxStateChanged"
QT_MOC_LITERAL(9, 138, 5) // "state"

    },
    "LoginForm\0userAuthenticated\0\0isAdmin\0"
    "authenticationSuccess\0on_loginButton_clicked\0"
    "on_adminCheckBox_toggled\0checked\0"
    "onCheckBoxStateChanged\0state"
};
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->userAuthenticated((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->authenticationSuccess(); break;
        case 2: _t->on_loginButton_clicked(); break;
        case 3: _t->on_adminCheckBox_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->onCheckBoxStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (LoginForm::*_t)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::userAuthenticated)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::authenticationSuccess)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginForm::userAuthenticated(bool _t1)
{
...
// SIGNAL 1
void LoginForm::authenticationSuccess()
{
